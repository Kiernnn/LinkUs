                    ...
                    <div class="create-wrapper mt-0">
                        <div class="create-form-container card p-4 shadow mt-2">
                            <div class="create">
                                ...
                                <a href="{{ route('posts.create') }}" class="create-text mt-2">{{ __('Create Post') }}</a>
                    ...
                    <div class="friend-wrapper mt-0">
                        <div class="friend-form-container card p-4 shadow mt-2">
                            @if ($viewingUser->totalFriends())
                                <div class="friend">
                                    <a href="{{ route('friends.showUser', $viewingUser->id) }}" class="friend-icon">
                                    ...
                                    <a href="{{ route('friends.showUser', $viewingUser->id) }}" class="friend-text mt-2">
                                        {{ __('Friends') }}</a>
                                    <p class="sub-text text-secondary">
