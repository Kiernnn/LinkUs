        ...
        <div class="home-content p-4">
            ...
            <form action="{{ route('posts.search') }}" method="POST" style="display: flex;">
                <div class="justify-content-center container">
                    @csrf
                    <input type="text" name="search" class="input" placeholder="Search Something" value="{{ old('search', $keyword ?? '') }}" style="font-style:italic;">
            ...
            @if(isset($keyword))
                ...
                <div class="scorll-search">
                    ...
                    @else
                        @if(!$users->isEmpty()) <h5>Users</h5> @endif
