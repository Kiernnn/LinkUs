    ...
    <div class="container">
        ...
        <div class="left">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="500" height="500"
                ...
                <path d="M159.91993,635.47388a289.004,289.004,0,0,0,28.12,28.95h806.58a289.004,289.004,0,0,0,28.12-28.95Z"
                ...
                <path
                    ...
                    transform="translate(-159.91993 -161.86389)" fill="#8300e2" />
                <path
        ...
        <div class="right">
            <h1 class="mb-3 mt-0">{{ __('Registration Form') }}</h1>
            <div>
